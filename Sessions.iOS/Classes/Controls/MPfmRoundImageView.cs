...
{
    [Register("SessionsRoundImageView")]
    public class SessionsRoundImageView : UIView
    {
        ...
        public SessionsRoundImageView() 
            : base()
        {
            Initialize();
        }

        public SessionsRoundImageView(IntPtr handle) 
            : base(handle)
        {
            Initialize();
        }
		...
		{
			SetTheme(GlobalTheme.BackgroundColor, GlobalTheme.MainLightColor, 1);
		}

		public void SetTheme(UIColor fillColor, UIColor strokeColor, float glyphAlpha)
		{
			FillColor = fillColor;
