...
{
    [Register("SessionsPlaylistTableViewCell")]
    public class SessionsPlaylistTableViewCell : UITableViewCell
    {
        public UIButton RightButton { get; private set; }

        public SessionsPlaylistTableViewCell() : base()
        {
            Initialize();
        }
        ...
        public SessionsPlaylistTableViewCell(UITableViewCellStyle style, string reuseIdentifier) : base(style, reuseIdentifier)
        {
            Initialize();
        }
