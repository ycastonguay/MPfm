...
{
    [Register("SessionsProgressBarView")]
    public class SessionsProgressBarView : NSView
    {
        ...
        [Export("init")]
        public SessionsProgressBarView() : base(NSObjectFlag.Empty)
        {
            Initialize();
        }

        // Called when created from unmanaged code
        public SessionsProgressBarView(IntPtr handle) : base (handle)
        {
            Initialize();
        }
