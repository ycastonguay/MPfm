...
{
    [Register("SessionsRoundButton")]
    public class SessionsRoundButton : NSButton
    {
        ...
        public delegate void ButtonSelected(SessionsRoundButton button);
        public event ButtonSelected OnButtonSelected;

        [Export("init")]
        public SessionsRoundButton() : base(NSObjectFlag.Empty)
        {
            Initialize();
        }

        // Called when created from unmanaged code
        public SessionsRoundButton(IntPtr handle) : base (handle)
        {
            Initialize();
        }
