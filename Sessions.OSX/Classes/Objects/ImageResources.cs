    ...
    public static class ImageResources
    {
        ...
        static ImageResources()
        {
            Images = new List<NSImage>() {
                ...
                NSImage.ImageNamed("toolbar_repeat_on"),
                NSImage.ImageNamed("toolbar_repeat_single"),
                NSImage.ImageNamed("toolbar_repeat_off"),
                NSImage.ImageNamed("toolbar_save"),
                NSImage.ImageNamed("toolbar_shuffle_on"),
                NSImage.ImageNamed("toolbar_shuffle_off"),
