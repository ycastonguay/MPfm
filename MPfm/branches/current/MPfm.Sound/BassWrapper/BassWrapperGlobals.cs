//
// BassWrapperGlobals.cs: This file contains global settings for the P/Invoke wrapper of the BASS audio library.
//
...
{
    public class BassWrapperGlobals
    {
#if IOS
        ...
        public const string DllImportValue_BassASIO = "__Internal";
        public const string DllImportValue_BassWASAPI = "__Internal";
#elif ANDROID || LINUX
        ...
        public const string DllImportValue_BassASIO = "libbassasio.so";
        public const string DllImportValue_BassWASAPI = "libbasswasapi.so";
#elif MAC
