...
namespace MPfm.WindowsControls
{
    ...
    public class TabButton : Control
    {
        ...
        /// <summary>
        /// Defines if the tab is currently selected. If so, a line will be drawn at the bottom of the control.
        /// </summary>
        [RefreshProperties(RefreshProperties.Repaint)]
        [Category("Misc"), Browsable(true), Description("Defines if the tab is currently selected. If so, a line will be drawn at the bottom of the control.")]
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            if (isSelected)
            {
                var pen = new Pen(theme.TextGradientDefault.BorderColor);
                pen.Width = 4;
                e.Graphics.DrawLine(pen, new PointF(0, ClientRectangle.Height), new PointF(ClientRectangle.Width, ClientRectangle.Height));
                pen.Dispose();
                pen = null;
            }
