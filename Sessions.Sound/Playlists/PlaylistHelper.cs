...
namespace Sessions.Sound.Playlists
{
    ...
    public static class PlaylistHelper
    {
        ...
        public static PlaylistFile LoadPlaylist(string filePath)
        {
        ...
        public static void SaveM3UPlaylist(string playlistFilePath, PlaylistFile playlist, bool useRelativePaths, bool useUTF8Encoding)
        {
            ...
            try
            {
                ...
                {
                    if (useRelativePaths)
                        writer.WriteLine(item.Replace(playlistPath + "\\", ""));
                    else
        ...
        /// <param name="playlist">Playlist object</param>
        /// <param name="useRelativePaths">Use relative paths</param>
        public static void SavePLSPlaylist(string playlistFilePath, PlaylistFile playlist, bool useRelativePaths)
        {
            StreamWriter writer = null;
            ...
            try
            {
                ...
                {                    
                    if (useRelativePaths)
                        writer.WriteLine("File" + (a + 1).ToString() + "=" + playlist.Items[a].Replace(playlistPath + "\\", ""));                        
                    else
                        writer.WriteLine("File" + (a + 1).ToString() + "=" + playlist.Items[a]);                        
        ...
        /// <param name="playlist">Playlist object</param>
        /// <param name="useRelativePaths">Use relative paths</param>
        public static void SaveXSPFPlaylist(string playlistFilePath, PlaylistFile playlist, bool useRelativePaths)
        {
            XDocument doc = null;
            string playlistPath = Path.GetDirectoryName(playlistFilePath);
            ...
            try
            {
                ...
                for (int a = 0; a < playlist.Items.Count; a++)
                {
                    ...
                    XElement elementTitle = new XElement(ns + "title", string.Empty); //playlist.Items[a].AudioFile.Title);
                    ...
                    if (useRelativePaths)
                    {
                        ...
                        elementLocation = new XElement(ns + "location", "file:///" + playlist.Items[a].Replace(playlistPath + "\\", "").Replace("\\","/"));
                    }
                    else
                    {
                        // Write absolute file path                        
                        elementLocation = new XElement(ns + "location", "file:///" + playlist.Items[a].Replace("\\", "/"));
                    }                        
